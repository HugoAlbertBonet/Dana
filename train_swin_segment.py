...
from models import UNet, SwinIR
...
# Networks
model = SwinIR(upscale=1, out_chans=1, img_size=(opt.size, opt.size),
                   window_size=8, img_range=1., depths=[1],
                   embed_dim=60, num_heads=[1], mlp_ratio=2, upsampler='pixelshuffledirect')
